...
\author{Adam Jakobsen
	\texttt{\href{mailto:adamjak@student.matnat.uio.no}{adamjak@student.matnat.uio.no}}
	\and\\
	Christophe Blomsen
	\texttt{\href{mailto:chriskbl@student.matnat.uio.no}{chriskbl@student.matnat.uio.no}}}               % self-explanatory
...
\section{Method}
\section{Results}
	% All of this might be moved around later, just adding the equations atm
	...
	\] 
	And since
	\begin{eqnarray} %to get equations underneath each other \nonumber to loose (1)
