...
def simulate_engine_performance(number_of_particles_in_box,
    ...
    dt = 10**-12
    steps = 1000
    motor = nm.nano_motor(box_side_length,number_of_particles_in_box,temperature,dt)
    for i in range(steps):
        motor.step()

    thrust_per_box = motor.calculated_thrust()
    mass_loss_rate_per_box = motor.fuel_consumption()
